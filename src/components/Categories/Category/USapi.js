...
const USapi = () => {
    ...
    const renderList = US.map((article, index) => {
        return(
            <div key={index}>
    ...
    return (
        <div className='ui container'>
            <h1 style={{fontSize: "64px", textAlign: "center", marginTop: "100px"}}>All Result For US</h1>
